...
SECRET_KEY = 'django-insecure-i!f+_x&6^c)--m!+e2g!f*blu8u0rs)#eb-(k!r&j6i!*8*wyj'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django_context.react_context.reactjs_assets_paths',  # context processor for react
            ],
        },
    },
]
...
STATICFILES_BASE = BASE_DIR / "react_staticfiles"
